...
% Can't add these in macros.tex since it's initialised before the glossary
\newcommand{\miniAOD}{mini\acrshort{aod}\xspace}
\newcommand{\nanoAOD}{nano\acrshort{aod}\xspace}
\newacronym{jec}{JEC}{jet energy corrections}

\newacronym{mev}{M\eV}{megaelectron volt}
\newacronym{gev}{G\eV}{gigaelectron volt}
\newacronym{tev}{T\eV}{teraelectron volt}
