...
Apps.~\ref{sec:B_only_fit_plots_ttH_SR} and \ref{sec:B_only_fit_plots_VH_SR} comprise the \ptmiss distributions in the signal region from the background-only fit. Corresponding event counts are presented in the main text under Chpt.~\ref{subsec:yield_tables_SR_B_only_fit}.
