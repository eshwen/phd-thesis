...
Apps.~\ref{sec:B_only_fit_plots_ttH_SR} and \ref{sec:B_only_fit_plots_VH_SR} comprise the \ptmiss distributions in the signal region from the fits to only the background. Corresponding event counts are presented in the main text under Chpt.~\ref{subsec:yield_tables_SR_B_only_fit}.
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[t]{0.48\textwidth}  % top align since figures are same dimensions, but x-axis labels are larger for likelihood
