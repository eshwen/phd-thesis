...
After calibrations, the energies of the generator and \acrshort{l1} \glspl{jet} are much more comparable and have a smaller spread. The \acrlong{jec} perform well, as intended and provide confidence for accurate calibrations in the calorimeter when data are collected.
