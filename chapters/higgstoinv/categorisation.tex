...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccccc}
        ...
        & 1W2b & $\geq \text{3}$ & $\geq \text{2}$ & 0 & 1 \\\cmidrule{8-8}
        & 5j1b & 5 & 1 & 0 & 0 & & $\Delta\phi(\Pbottom_1, \ptvecmiss) > \text{1.0}$, \\
        & 6j1b & $\geq \text{6}$ & 1 & 0 & 0 & & $\Delta\phi(\jone, \ptvecmiss) > \pi/\text{2}$\\\cmidrule{8-8}
