...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccccc}
        \hline\hline
        Category & Subcategory & \njet & \nbjet & \nBoostedTop & \nBoostedV & Angular cut & Other \\
        \hline
        \multirow{9}{*}{\ttH} & 2Boosted & $\geq \text{0}$ & $\geq \text{0}$ & \multicolumn{2}{c}{2} & \multirow{9}{*}{$\omegaTilde > \text{0.3}$} & \multirow{5}{*}{---} \\
        ...
        \multirow{4}{*}{\VH} & 2j0b & 2 & 0 & 0 & 0 & \multirow{4}{*}{$\omegaTilde > \text{0.5}$} & $\mjj \in [\text{65}, \text{105})$ \\
        & 2j1b & 2 & 1 & 0 & 0 & & $\mjj \in [\text{65}, \text{105})$ \\
        & 2j2b & 2 & 2 & 0 & 0 & & $\mjj \in [\text{65}, \text{105})$ \\
        & 1V & 0 & 0 & 0 & 1 & & ---\\\hline
        \multirow{4}{*}{\ggH}& 2jM & 2 & 0 & 0 & 0 & \multirow{4}{*}{$\omegaTilde > \text{0.7}$} & $\mjj \notin [\text{65}, \text{105})$ \\
        & 3j & 3 & 0 & 0 & 0 & & ---\\
        & 4j & 4 & 0 & 0 & 0 & & ---\\
...
% Consider restructuring above paragraphs a bit, or add paragraphs/subsections for each category describing how/why we define the subcategories. Account for failure to tag objects (e.g., boosted objects in all ttH boosted categories bar 2Boosted), and also mis-tagging (>= 2b in ttH 5j2b and 6j2b, since we don't want to remove the small fraction of signal events that could have 2 correctly identified b-jets and 1 or more mis-tagged ones)
