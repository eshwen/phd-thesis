...
python plot_multi_signifs.py -y $year -e $ext -p ttH_1t1b output_dfs/out_category_1.02_SoverSqrtB.csv output_dfs/out_category_1.02_SoverSqrtB_uncertainty5pc.csv output_dfs/out_category_1.02_asimov.csv output_dfs/out_category_1.02_asimov_uncertainty5pc.csv
python plot_multi_signifs.py -y $year -e $ext -p ttH_1t2b output_dfs/out_category_1.03_SoverSqrtB.csv output_dfs/out_category_1.03_SoverSqrtB_uncertainty5pc.csv output_dfs/out_category_1.03_asimov.csv output_dfs/out_category_1.03_asimov_uncertainty5pc.csv
