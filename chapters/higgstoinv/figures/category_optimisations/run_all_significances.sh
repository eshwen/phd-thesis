...
python plot_multi_signifs.py -y $year -e $ext -p ggH out_ggH_combined_SoverSqrtB.csv out_ggH_combined_SoverSqrtB_uncertainty5pc.csv out_ggH_combined_asimov.csv out_ggH_combined_asimov_uncertainty5pc.csv
