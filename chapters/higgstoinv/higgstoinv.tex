...
% The material in this subsection is up-to-date as of 1st June. This, more than most, may be subject to change
...
% Give an outline of the how the fit is done and how the background estimation methods factor in, etc. Like background estimation, describe it generally
...
\section{Analysis of the \texorpdfstring{\ggF}{ggF} mode}
...
% Include dark matter limit plot using the BR limit we obtain for a SM Higgs, with explanations. Will potentially also look at signal samples with non-Standard Model Higgs masses. Some useful info on those: https://twiki.cern.ch/twiki/bin/view/LHCPhysics/CERNYellowReportPageBSMAt13TeV
