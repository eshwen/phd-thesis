...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/limits/monojet/limit_2016_monojet_Scenario5.pdf}
        \caption{Monojet --- 2016}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/limits/monojet/limit_2017_monojet_Scenario5.pdf}
        \caption{Monojet --- 2017}
    \end{subfigure}

    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth]{figures/limits/monojet/limit_2018_monojet_Scenario5.pdf}
...
%        \includegraphics[width=\textwidth]{figures/limits/limit_full_Run2_comb_Scenario5.pdf}
%        \caption{Expected limit -- Run-2}
%    \end{subfigure}
%    \hspace{0.05\textwidth}
%    \begin{subfigure}[b]{0.45\textwidth}
%        \includegraphics[width=\textwidth]{figures/likelihood_scan/full_Run2/profile_likelihood_scan_Run2_Scenario5.pdf}
...
% Expected limits and likelihoods only, for Scenario 5. Have plots with VBF, but not combined with them. All limit and likelihood plots from 30th July

% Need to fix likelihood curve with monojet in 2018. Something wrong with the 1j0b category
