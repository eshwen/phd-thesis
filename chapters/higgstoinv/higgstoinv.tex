...
% blank line to start new row
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \caption{\ggF}
    \end{subfigure}
\caption[The Feynman diagrams for the four main hadronic production modes of the Higgs boson]{The Feynman diagrams for the four main hadronic production modes of the Higgs boson.} % To add a shorter caption for the figure in the List of Figures, add the shorter caption inside square brackets before the main one, i.e., \caption[Reduced caption]{Full caption}. Avoid a full stop at the end of a reduced caption since it looks ugly in the table of contents
