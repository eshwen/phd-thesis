...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Efficiency of the \ptmiss--\mht cross triggers in 2016 data and simulation. The momentum of the muon used to select events that }
...
% Need to figure out whether MC is weighted by xsec x lumi (for getting SF if not for efficiency plot)
