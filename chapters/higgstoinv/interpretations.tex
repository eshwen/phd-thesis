...
For $\BRof{\higgstoinv} < \text{0.28}$ observed at a 95\,\% confidence level (corresponding to 0.24 at a 90\,\% confidence level), the Higgs portal models assuming scalar and fermion dark matter candidates set the lowest limits on \xsecSI for \mqdark below 7 and 15\GeV, respectively.
