...
\noindent{}The \acrshort{qcd} reduction criteria from Tab.~\ref{tab:htoinv_categories} are applied in the signal region, but not to any of the \glspl{CR}. This was to improve the statistical accuracy in the \glspl{CR}, and was found to avoid compromising the data--simulation agreement and the shapes of the important distributions.\footnote{Might put the angular variables into the CRs for \ggH. If so, update these sentences.}
