...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.9\textwidth}
        ...
        \caption{\ttH --- 2018}
    \end{subfigure}
    \caption[Pre-fit and post-fit yields in the signal region for every \ttH category and \ptmiss bin in each year of Run-2]{Pre-fit and post-fit yields in the signal region for every \ttH category and \ptmiss bin in each year of Run-2. ``Pre-fit'' refers to outcome of the \gls{CR}--only prediction.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.9\textwidth}
        ...
        \caption{\VH --- 2018}
    \end{subfigure}
    \caption[Pre-fit and post-fit yields in the signal region for every \VH category and \ptmiss bin in each year of Run-2]{Pre-fit and post-fit yields in the signal region for every \VH category and \ptmiss bin in each year of Run-2. ``Pre-fit'' refers to outcome of the \gls{CR}--only prediction.}
