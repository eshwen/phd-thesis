...
Since the copied events can migrate between subcategories and \ptmiss bins relative to their nominal counterpart, large and sometimes same-sided uncertainties can arise, especially in bins with low event yields or high \gls{jet} multiplicity. The uncertainties are therefore parametrised across the categories, \ptmiss bins and regions in the analysis to [give] smoother variations. This resulted in a 3\,\% uncertainty combined over the \acrshort{jer} and \acrshort{jes} sources.
