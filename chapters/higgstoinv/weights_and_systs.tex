...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/nlo_k_factors/1D_all_ewk.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/top_pt_reweighting/top_pt_reweighting_central.pdf}
