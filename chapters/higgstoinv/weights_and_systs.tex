...
where $N_{\mathrm{MC}}$ is the number of unweighted, simulated events in the bin. In data/\acrshort{mc} distributions, the statistical uncertainty ascribed to the \acrshort{mc} yield in a bin is estimated from the unweighted number of events ($k$ in a Poisson statistical treatment):
\begin{equation}
