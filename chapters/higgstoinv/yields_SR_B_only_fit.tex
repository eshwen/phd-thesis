...
\begin{table}[htbp]
    ...
    \ttH 1t2b & [200, 300) &    $\text{44.2} \pm \text{2.72}$ &   $\text{3.02} \pm \text{1.28}$ &  $\text{7.95} \pm \text{2.44}$ &    $\text{55.2} \pm \text{3.88}$ &    51 & $-$0.6 \\
        ...
        & [600, $\infty$) &    $\text{2.22} \pm \text{0.52}$ &   $\text{1.36} \pm \text{0.99}$ &  $\text{0.14} \pm \text{0.04}$ &    $\text{3.72} \pm \text{1.12}$ &     4 & 0.1 \\
    \ttH 1W1b & [200, 300) &   $\text{362} \pm \text{11.7}$ &   $\text{41.3} \pm \text{8.72}$ &  $\text{18.1} \pm \text{5.54}$ &   $\text{422} \pm \text{15.6}$ &   396 & $-$1.3 \\
        & [300, 400) &     $\text{81.5} \pm \text{5.1}$ &   $\text{32.4} \pm \text{7.12}$ &  $\text{6.71} \pm \text{2.04}$ &   $\text{121} \pm \text{8.99}$ &   112 & $-$0.9 \\
        & [400, $\infty$) &    $\text{15.3} \pm \text{1.45}$ &   $\text{10.6} \pm \text{2.88}$ &  $\text{3.27} \pm \text{1.01}$ &    $\text{29.1} \pm \text{3.38}$ &    32 & 0.5 \\
    \ttH 1W2b & [200, 300) &    $\text{260} \pm \text{9.2}$ &    $\text{3.9} \pm \text{2.19}$ &  $\text{12.2} \pm \text{3.77}$ &   $\text{276} \pm \text{10.2}$ &   264 & $-$0.7 \\
        & [300, 400) &    $\text{51.3} \pm \text{3.26}$ &   $\text{4.41} \pm \text{2.52}$ &  $\text{4.53} \pm \text{1.38}$ &    $\text{60.3} \pm \text{4.35}$ &    65 & 0.6 \\
        & [400, $\infty$) &     $\text{7.8} \pm \text{1.01}$ &    $\text{1.2} \pm \text{0.73}$ &  $\text{2.18} \pm \text{0.68}$ &    $\text{11.2} \pm \text{1.41}$ &    11 & $-$0.1 \\
    \ttH 5j1b & [200, 300) &  $\text{1557} \pm \text{32.9}$ &  $\text{558} \pm \text{53.4}$ &  $\text{46.5} \pm \text{14.0}$ &  $\text{2161} \pm \text{64.3}$ &  2192 & 0.7 \\
        & [300, 400) &   $\text{292} \pm \text{11.0}$ &  $\text{193} \pm \text{18.6}$ &  $\text{17.1} \pm \text{5.51}$ &   $\text{502} \pm \text{22.3}$ &   516 & 0.6 \\
        & [400, $\infty$) &    $\text{54.5} \pm \text{4.13}$ &  $\text{119} \pm \text{12.6}$ &  $\text{8.25} \pm \text{2.51}$ &   $\text{182} \pm \text{13.5}$ &   189 & 0.5 \\
    \ttH 6j1b & [200, 300) &   $\text{907} \pm \text{23.1}$ &  $\text{250} \pm \text{30.6}$ &  $\text{35.3} \pm \text{10.9}$ &  $\text{1192} \pm \text{39.9}$ &  1193 & 0.0 \\
        & [300, 400) &    $\text{186} \pm \text{9.7}$ &  $\text{109} \pm \text{15.1}$ &  $\text{13} \pm \text{3.97}$ &   $\text{309} \pm \text{18.4}$ &   315 & 0.3 \\
        & [400, $\infty$) &    $\text{51.5} \pm \text{3.68}$ &   $\text{50.1} \pm \text{10.1}$ &  $\text{6.31} \pm \text{1.92}$ &   $\text{108} \pm \text{10.9}$ &   114 & 0.6 \\
...
\begin{table}[htbp]
    ...
    \ttH 1W1b & [200, 300) &   $\text{378} \pm \text{12.6}$ &   $\text{30.1} \pm \text{5.82}$ &  $\text{21.3} \pm \text{5.83}$ &   $\text{430} \pm \text{15.0}$ &   410 & $-$1.0 \\
        & [300, 400) &    $\text{93.8} \pm \text{4.48}$ &   $\text{13.8} \pm \text{4.38}$ &  $\text{8.14} \pm \text{2.25}$ &   $\text{116} \pm \text{6.66}$ &   110 & $-$0.6 \\
        & [400, $\infty$) &    $\text{16.4} \pm \text{1.35}$ &   $\text{6.95} \pm \text{1.78}$ &   $\text{4.3} \pm \text{1.19}$ &    $\text{27.6} \pm \text{2.53}$ &    35 & 1.3 \\
    \ttH 1W2b & [200, 300) &   $\text{286} \pm \text{11.5}$ &    $\text{7.8} \pm \text{3.38}$ &  $\text{14.5} \pm \text{3.93}$ &   $\text{309} \pm \text{12.6}$ &   302 & $-$0.4 \\
        & [300, 400) &    $\text{54.9} \pm \text{3.56}$ &   $\text{5.11} \pm \text{2.46}$ &  $\text{5.56} \pm \text{1.57}$ &     $\text{65.6} \pm \text{4.6}$ &    74 & 1.0 \\
        & [400, $\infty$) &    $\text{6.92} \pm \text{0.88}$ &   $\text{2.04} \pm \text{0.71}$ &  $\text{2.88} \pm \text{0.79}$ &    $\text{11.8} \pm \text{1.39}$ &    14 & 0.6 \\
    \ttH 5j1b & [200, 300) &  $\text{1842} \pm \text{33.1}$ &  $\text{570} \pm \text{48.7}$ &  $\text{59.1} \pm \text{16.5}$ &  $\text{2471} \pm \text{61.2}$ &  2514 & 0.9 \\
        & [300, 400) &   $\text{290} \pm \text{10.4}$ &  $\text{239} \pm \text{21.9}$ &  $\text{22.1} \pm \text{6.49}$ &   $\text{551} \pm \text{25.1}$ &   540 & $-$0.5 \\
        & [400, $\infty$) &    $\text{54.6} \pm \text{3.61}$ &   $\text{85.6} \pm \text{11.9}$ &  $\text{11.6} \pm \text{3.24}$ &   $\text{152} \pm \text{12.9}$ &   152 & 0.0 \\
    \ttH 6j1b & [200, 300) &  $\text{1001} \pm \text{22.2}$ &  $\text{259} \pm \text{32.5}$ &  $\text{43.2} \pm \text{12.2}$ &  $\text{1303} \pm \text{41.2}$ &  1295 & $-$0.2 \\
        & [300, 400) &   $\text{204} \pm \text{8.13}$ &  $\text{120} \pm \text{15.5}$ &  $\text{16.5} \pm \text{4.66}$ &   $\text{341} \pm \text{18.1}$ &   343 & 0.1 \\
        & [400, $\infty$) &    $\text{54.3} \pm \text{3.89}$ &   $\text{52.2} \pm \text{9.05}$ &  $\text{8.59} \pm \text{2.48}$ &   $\text{115} \pm \text{10.2}$ &   121 & 0.5 \\
    \ttH 5j2b & [200, 300) &   $\text{515} \pm \text{15.4}$ &  $\text{129} \pm \text{19.0}$ &  $\text{10.9} \pm \text{2.93}$ &   $\text{654} \pm \text{24.6}$ &   651 & $-$0.1 \\
        & [300, 400) &    $\text{47.5} \pm \text{3.67}$ &   $\text{44.0} \pm \text{8.57}$ &  $\text{4.14} \pm \text{1.16}$ &    $\text{95.7} \pm \text{9.39}$ &   106 & 1.0 \\
