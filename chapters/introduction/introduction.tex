...
Also testing references: \cite{CMS-PAPER-SUS-15-005-arXiv} (article), \cite{tagkey1984quarksandleptons} (book), \cite{Lisanti:2016jxe} (inproceedings), \cite{CMS-PAS-SUS-15-005} (techreport).

Testing numbers: 1234567890

Testing alphabet: The quick brown fox jumps over the sleazy dog

Testing equations:

\begin{equation}
B(P) = \frac{\mu_0}{4]pi} \int \frac{I \times \hat{r}}{\bar{r}^2}dr
\end{equation}
