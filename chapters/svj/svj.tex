...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures/t_channel_benchmark_variations/dijet_mt/rinv.pdf}
        \caption{Varying \rinv}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{figures/t_channel_benchmark_variations/dijet_mt/aD.pdf}
        \caption{Varying \aDark}
    \end{subfigure}
