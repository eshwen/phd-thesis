...
Despite the \acrlong{sm} providing precise predictions of three of the four fundamental forces and the particles that they interact with, there are many experimental observations that it cannot currently explain. Neutrino masses, dark matter, dark energy, and gravity all escape its description. Testing \TeV \tTeV.

% Mention the hierarchy problem as well - Significant fine-tuning required to cancel quadratic divergences of Higgs mass -> points to new physics below ~10 TeV. Ties into some Higgs and dark matter stuff nicely.
...
% Should I add a figure/plot to break up the text? Maybe the Higgs coupling strength? Or some plot regarding Higgs coupling to dark matter?
