...
before the manifestation of electroweak symmetry breaking. where each term can be expanded to yield
\begin{equation}
    \begin{aligned}
...
\end{equation}
% When using 'aligned' environment, don't indent each equation line, otherwise it complains
