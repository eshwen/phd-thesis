...
{\HUGE Hadronic Dark Matter Searches at \acrshort{cms} at $\sqrt{s} = \text{13\TeV}$}\\[4mm] % title. Not using \comruntwo macro so that "13" is rendered in the main text font
{\Large \textit{Searches for invisibly decaying Higgs bosons and \glspl{svj}}}\\ % subtitle
...
\end{minipage}\\
\vspace{9mm}
{\large\textsc{April 2020}}  % date of submission
\vspace{12mm}
\end{center}
\begin{flushright}
