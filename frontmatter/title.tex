...
{\Large \textit{Searches for dark matter with a focus on invisibly decaying Higgs bosons in the ttH, VH, and ggH channels using the full Run-2 dataset from the CMS experiment at the LHC}}\\ % subtitle
