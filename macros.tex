...
% Not sure if I should continue using the particle names from hepnames/ptdr-definitions (as they tend to produce them upright) or whether to use the italic math verisons. If the latter, will have to edit macros below.

% Higgs to inv. control regions
\newcommand{\singleMuCr}{\ensuremath{\Pgm + \text{jets}}\xspace} 
\newcommand{\doubleMuCr}{\ensuremath{\Pgm\Pgm + \text{jets}}\xspace}
\newcommand{\singleEleCr}{\ensuremath{\Pe + \text{jets}}\xspace}
\newcommand{\doubleEleCr}{\ensuremath{\Pe\Pe + \text{jets}}\xspace}
...
\newcommand{\ptjone}{\ensuremath{\ptsup{\mathrm{j}_1}}\xspace}
\newcommand{\ptjtwo}{\ensuremath{\ptsup{\mathrm{j}_2}}\xspace}
\newcommand{\etajone}{\ensuremath{\etasub{\mathrm{j}_1}}\xspace}
\newcommand{\etajtwo}{\ensuremath{\etasub{\mathrm{j}_2}}\xspace}
...
\newcommand{\PVec}{\ensuremath{\mathrm{V}}}  % couldn't find command for generic V boson so created one
...
\newcommand{\ztonunupjets}{\ensuremath{\PZ(\rightarrow \Pgn\Pagn) + \text{jets}}\xspace}
\newcommand{\wtolnupjets}{\ensuremath{\PW(\rightarrow \ell\Pgn) + \text{jets}}\xspace}
