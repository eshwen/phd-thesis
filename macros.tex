...
\newcommand{\PVec}{\ensuremath{V}\xspace}  % couldn't find command for generic V boson so created one. Note that this is italic, so depending on style choice for particles being upright/italic, may have to change
