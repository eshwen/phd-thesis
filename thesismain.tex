...
\newcommand{\citenumNegSpace}{\ensuremath{\mkern-4.5mu}}  % Sometimes the above \citenum command adds an erroneous space after it before subsequent puncuation, e.g., "Ref. 42 )" instead of "Ref. 42)". Account for that with this macro
...
% ======================================
% Stylise epigraphs (environment to use, e.g., a quote at the beginning of a chapter)
